  ...
  return (
    <div className='m-5  ml-20 md:ml-40 lg:ml-65 py-5 w-full'>
      ...
      <div className='flex flex-col sm:flex-row gap-3 w-full'>
          ...
          <div className='w-full sm:w-1/3 flex items-center gap-2 bg-white p-4 min-2-52 rounded border-2 border-gray-100 cursor-pointer hover:shadow hover:scale-105 transition-all duration-500'>
          ...
          <div className='pt-4 border  border-gray-300 border-t-0'>
            {
              dashData.latestBooking?.length > 0 ? (
                dashData.latestBooking.map((item, index) => (
                  <div className=' sm:flex justify-between items-center gap-4 px-4 py-2 border-b border-gray-300' key={index}>
                    ...
                    <div>
                      {item.cancelled ? (
                        ...
                        <div className=' mt-4 sm:mt-0 flex items-center justify-center gap-2'>
                          ...
                          <p onClick={() => cancleBooking(item._id)} className='text-red-600 text-base border py-1 px-2 rounded-full cursor-pointer border-red-600 bg-red-100'>Cancel Booking</p>
                        </div>
                      )}
                    </div>
                  </div>
