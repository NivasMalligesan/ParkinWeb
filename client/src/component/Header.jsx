...
const Header = () => {
  return (
    ...
    className='sm:mt-20 flex flex-col md:flex-row flex-wrap bg-primary rounded-lg px-6 md:px-10 lg:px-20 relative'
    >
        {/* Left side of the header */}
        <div className='md:w-1/2 flex flex-col items-start justify-center gap-4 py-20 md:py-[5vw]'>
            <p className=' text-3xl md:text-4xl lg:text-5xl text-white font-semibold leading-tight'>
                Find, Reserve and Park<br /> Parking at Your Fingertips
            </p>
            <div className='flex items-center gap-5'>
                <img src={assets.group_profiles} alt="" className="w-32 h-auto" />
